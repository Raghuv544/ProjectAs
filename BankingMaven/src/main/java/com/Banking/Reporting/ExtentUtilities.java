...
public class ExtentUtilities {
    ...
    public static AutomationCore autoCore = null;
    public static boolean flag=false;
	
	public static void initilaizeExtentReport()
	{
		if(flag==false)
		{
			...
			System.out.println("extent report path is" +System.getProperty("user.dir")+File.separator+autoCore.Environment("extentReportPath"));
			extent = ExtentManager.createInstance(System.getProperty("user.dir")+File.separator+autoCore.Environment("extentReportPath"));
...
////        extent.flush();
//	}
	public static void logWithTitle(String stepName)
	{
		try
		{
